...
function Area_check(para) {
  return para === "Taiwan" ? "Taiwan" : para;
}
...
let title = `${flags.get(obj.location.country_code)} | ${Area_check(obj.location.country)} ${City_ValidCheck(obj.location.city)}`;
let subtitle = `🌐 | ${ISP_ValidCheck(obj.company.name)}`;
let ip = obj.ip;
let description = `ASN: ${obj.company.name}
